...
public class CommuController {
	...
	public String saveImg(Community commu, @RequestParam(value = "file", required = false)MultipartFile file, @AuthenticationPrincipal PrincipalDetail principal) throws Exception {
