          ...
          <div class="row float-left">
            <div class="col-lg-6 col-md-6 pb-1">
              ...
              <div
                ...
                <img src="../img/dogImg/icon/pet-food.png" alt="음식" class="h1 font-weight-normal text-primary mb-3" style="width:15%; height: 15%;">
                <div class="pl-4">
                  <ul>
                    <li>사료) 로얄캐닌 닥스훈트 어덜트 1.5kg 관절 건강 85g</li>
                    <li>간식) 당근 1조각, 오이 1조각</li>
                  </ul>
                </div>
              </div>
            </div>
