...
<div class="container-fluid pt-5">
	<div class="container">
		<div class="bg-light p-5 rounded">
			<div class="mb-4">
				<h2 class="mb-1">오늘의 활동</h2>
			</div>
			<div class="row">
				<div class="row float-left">
					<c:forEach var="activity" items="${petnotices.content}">
						<c:if test="${pets.petId eq activity.pet.petId}">
							<div class="col-lg-6 col-md-6 pb-1">
								<h6><fmt:formatDate value="${activity.createDate}" pattern="yyyy-MM-dd"/></h6>
								<div class="d-flex shadow-sm rounded"
									style="padding: 30px; background-color: white;">
									<img src="../img/dogImg/icon/강아지채크.png" alt="활동"
										class="h1 font-weight-normal text-primary mb-3"
										style="width: 15%; height: 15%;">
									<div class="pl-4">${activity.content}</div>
								</div>
