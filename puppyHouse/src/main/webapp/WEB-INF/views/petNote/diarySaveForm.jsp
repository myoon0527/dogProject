  ...
  <div class="container">
    <div class="mb-4">
     ...
     <div class="col col-lg-12 mb-3 justify-content-center">
        <form class="justify-content-center mx-auto" action="/petNote/diary/saveImg/${petId}" method="POST" enctype="multipart/form-data">
          <input type="hidden" value="${petId}">
          <br>
          <div class="border border1 img-fluid mx-auto " style="border-radius: 70%; width: 230px; height: 220px; overflow: hidden;">
			<img class="img-fluid w-100" id="user_image" src="/img/dog.png" alt="다이어리 사진" style="width: 100%; height: 100%; object-fit: cover;">
   		  </div>
          ...
          <br>
          <Br>
          <div class="justify-content-center mx-auto" style="width:83px;">
