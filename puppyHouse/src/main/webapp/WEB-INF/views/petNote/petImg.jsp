	...
	<div class="container-fluid mb-5">
		<div class="container bg-primary">
			<div class="col">
				...
				<form action="/pet/saveImg" method ="POST" enctype="multipart/form-data">
					<div class="col-lg-3 bg-primary mx-auto" style="padding-bottom: 50px">
						<div class="col-lg-12 text-center">
							<label for="file" class="border border-2 btn btn-light py-2 px-4" style="padding: 8px; margin-top: 15px;">프로필 사진 업로드</label>
                  			<input type="file" class="d-none" id="file" name="file" accept="image/jpeg, image/png" onchange="PreviewImage();">
                  			<p class="help-block text-danger"></p>
						</div>
							<div class="col-lg-12 text-center">
					 		<input type="submit" class="border border-2 btn btn-light py-2 px-4" style="padding: 8px;" value="상세정보 등록하기">
						</div>
					</div>
				</div>
			</form>
