    ...
    <div class="container p-5">
     <div class="col-12 text-center mb-2">
      <a href="../user/updateForm.jsp" class="btn btn-outline-primary m-1" 
        style="color: #17a2b8; background-color: #fff;">회원정보 수정</a>
      <a href="myReserve.jsp" class="btn btn-outline-primary m-1 active"
      ...
      <div class="mx-auto col-12 col-xl-10 col-lg-10 px-md-5 px-lg-5 px-xl-5">
        ...
        <form class="mx-auto col-12">
          <div class="row justify-content-around px-5 px-md-0 px-sm-0">
            ...
            <div class="form-group col-3 px-md-0 px-sm-0">
              ...
              <select id="dogname" class="form-control">
                <option selected>${dogname}</option>
          ...
          <div class="row-cols-2 mx-auto d-flex justify-content-center">
            <button class="btn btn-danger col-2  mx-2 py-2 px-4 " type="button" id="sendMessageButton">
              예약 삭제</button>
            <button class="btn btn-primary col-2 mx-2 py-2 px-4" type="submit" id="sendMessageButton">
              변경완료</button>
          </div>
        </form>
      </div>
