...
<!-- 섹션 1 start -->
  <div class="container-fluid bg-primary mb-5">
      ...
      >
        <h3 class="display-3 font-weight-bold text-white" style="font-family: Noto sans Korean">애견수첩 수정하기</h3>
      ...
      <div class="col-lg-7 mb-5">
        <div class="contact-form">
          ...
          <form name="sentMessage" id="contactForm" novalidate="novalidate">
            ...
            <div class="control-group">
              <input type="text" class="form-control" id="name" placeholder="강아지 이름" required="required">
              <p class="help-block text-danger"></p>
            </div>
            <div class="control-group">
                <input type="radio" name="birthday" value="0" checked="checked">생년월일
                <input type="radio" name="birthday" value="1">나이입력
              <div><input type="date" class="form-control" name="date" size="20" required="required"></div>
              <div><input type="text" class="form-control" name="date" size="20" placeholder="강아지 나이" required="required"></div>
              <p class="help-block text-danger"></p>
            </div>
            <div class="control-group">
            ...
            <div class="row">
              <div class="col text-center">
                <button class="btn btn-primary py-2 px-4" type="submit" id="sendMessageButton">수정하기</button><button class="btn btn-danger py-2 px-4 ml-2" type="submit" id="sendMessageButton">삭제하기</button>
              </div>
            </div>
          </form>
        </div>
